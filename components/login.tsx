  ...
  return (
    <div className="absolute top-0 w-screen h-screen z-10 bg-gray-200 bg-opacity-30">
      <div className="absolute w-screen h-screen z-20 flex justify-center items-center">
        <div className="w-3/4 sm:w-1/2 lg:w-1/2 xl:w-1/4  h-2/3 flex flex-col border-4 border-gray-400 rounded-3xl shadow-2xl bg-white ">
          <div className="h-1/4 xl:h-1/5 text-3xl xl:text-4xl border-b-2 w-full flex justify-between items-center px-10">
            <p>Login</p>
            <Image
